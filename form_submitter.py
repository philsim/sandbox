...
# the below code is only for replacing relative URLs to absolute ones so we can adequately browse the page locally in our computer.
...
webbrowser.get(firefox_path).open("page.html")